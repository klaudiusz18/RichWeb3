...
(function() {
    ...
    var app = {
      ...
      addButton: document.getElementById('btn1'),
      errorDisplay: document.getElementById('error'),
      deleteButton: document.querySelector('delete1'),
      editButton: document.querySelector('edit1'),
      ...
      addNote: function(note) {
       ...
       let button2 = document.getElementById('delete1');
       Rx.Observable.fromEvent(button2,'click')
       .subscribe(
           (value)=> delete1(button2.value)
       ); 
        ...
        let button3 = document.getElementById('edit1');
        Rx.Observable.fromEvent(button3,'click')
       .subscribe(
           (value)=> edit1(button3.value)
       );
